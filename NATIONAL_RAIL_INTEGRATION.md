...
| Button | Icon | Action |
|--------|------|--------|
| Add | ➕ Plus | Opens station search modal |
| Refresh | 🔄 Circular arrows | Manually refreshes all stations |
| Clear | 🗑️ Trash | Clears all saved stations |
...
### Web App (Next.js)
- **Directory:** `london-transit-web/`
- **Framework:** Next.js 15 with App Router
- **Storage:** Browser localStorage
- **API Key:** Server-side via environment variable

### Mobile App (React Native) - Coming Soon
- **Directory:** `london-transit-mobile/`
- **Framework:** React Native with Expo
- **Storage:** AsyncStorage (on-device)
- **API Key:** User-provided on first launch
